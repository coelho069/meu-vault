---
title: "MOC — Tronco Cerebral Central"
tier: index
tags:
  - moc
  - cerebro
  ...
  - memoria-agente
  - hermes
created_at: 2026-06-27T03:25:58Z
...
```mermaid
graph TD
    BRAIN[MOC_Cerebro_Central]
    BRAIN --> MOC1[MOC_Indice_Geral]
    BRAIN --> MOC_2[MOC_Cerebro_Central]
    BRAIN --> MOC_3[MOC_Indice_Geral]
    BRAIN --> ORPHANS[Rede Neural Orfa]
    ORPHANS --> O0[analisar-chat-integracao]
    ORPHANS --> O1[repo-analyze-https-githu]
    ORPHANS --> O2[repo-analyze-https-githu]
    ORPHANS --> O3[resumo-hoje]
```
