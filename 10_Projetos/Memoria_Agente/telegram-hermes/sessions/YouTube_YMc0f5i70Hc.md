...
O ganho observado é descrito como “bem gritante” e aparece com números concretos. No teste com o [[Qwen 3.6 35B A3B Coding NVFP4]], o desempenho saiu de aproximadamente 45 [[Tokens]] para 108 [[Tokens]] dentro do [[Olhama]]. Em outro modelo de 27 bilhões de parâmetros, a velocidade foi de 16 para 26 tokens por segundo. Esses números são importantes porque mostram que a otimização não é marginal: no primeiro caso, a troca para [[MLX]] mais que dobrou a vazão de geração. Para um [[Agente]] como o [[Agent]], isso muda a experiência operacional. Um agente local lento pode parecer “burro” ou improdutivo simplesmente porque cada iteração custa tempo demais; quando a latência cai e a vazão sobe, o mesmo modelo passa a
